...
namespace DevClient.Clients
{
    public class CanadaComputersClient
    {
        ...
        private readonly DevClient.Data.ITcgSourceUrlRepository? _sourceUrlRepo;
        ...
        public CanadaComputersClient(DevClient.Data.ITcgSourceUrlRepository? sourceUrlRepo = null)
        {
        ...
        public async Task<List<Search>> GetPokemon()
        {
            ...
            try
            {
                ...
                if ((configured == null || configured.Count == 0) && _sourceUrlRepo != null)
                {
                    ...
                    try
                    {
                        _sourceUrlRepo.Add(new DevClient.Data.TcgSourceUrl
                        {
